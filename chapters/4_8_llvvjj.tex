...
\begin{figure}[!htbp]
    \centering
    \subfloat[]{
        \includegraphics[width=0.3\linewidth]{figures/llvv/fig_postfit_d.pdf}
        \label{fig:postfit_leading_jet_pt}
    }
    \hfill
    \subfloat[]{
        \includegraphics[width=0.3\linewidth]{figures/llvv/fig_postfit_e.pdf}
        \label{fig:postfit_mjj}
    }
    \hfill
    \subfloat[]{
        \includegraphics[width=0.3\linewidth]{figures/llvv/fig_postfit_f.pdf}
...
\begin{figure}[p]
    \centering
    \subfloat[]{
        \includegraphics[width=0.45\linewidth]{figures/llvv/fig_diff_llvvjj_a.pdf}
        \label{fig:diff_llvvjj_z_pt}
    }
    \hfill
    \subfloat[]{
        \includegraphics[width=0.45\linewidth]{figures/llvv/fig_diff_llvvjj_b.pdf}
    ...
    \subfloat[]{
        \includegraphics[width=0.45\linewidth]{figures/llvv/fig_diff_llvvjj_c.pdf}

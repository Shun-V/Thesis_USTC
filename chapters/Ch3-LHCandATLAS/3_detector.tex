...
\begin{figure}[!htbp]
    ...
    \caption{The CERN accelerator complex~\cite{CERNAccComplex}.}
...
\begin{table}[htbp]
  \centering
  \caption{Timeline of LHC operations and major milestones~\cite{Apollinari:2015bam}.}
...
\begin{table}[htbp]
\centering
\caption{LHC operation parameters for the Run-2 data-taking period~\cite{Bruning:2004,Evans:2008zzb}.}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.95\linewidth]{figures/ch3-LHC-ATLAS/LHC-plan-2026.png}
    \caption{The road map of the LHC~\cite{Apollinari:2015bam}.}
...
\begin{figure}[!htbp]
    ...
    \caption{The ATLAS detector~\cite{ATLAS2008}.}
...
\hline
\end{tabular}
\caption{Performance requirements of major ATLAS detector components~\cite{PERF-2007-01,ATLAS2008}.}
...
\begin{figure}[!htbp]
    ...
    \caption{The ATLAS Inner Tracker~\cite{ATLAS2008}.}
...
\begin{figure}[!htbp]
    ...
    \caption{The 3-dim views of the ID, left panel--barrel, and right panel--end-cap region~\cite{ATLAS2008}.}
...
\begin{tabular}{c|c c}
    ...
    \hline\hline
\end{tabular}
\caption{Main Characteristics of the IBL and Pixel Detectors~\cite{ATLAS2008}.}
...
\hline\hline
\end{tabular}
\caption{Main Characteristics of the SCT and TRT detector~\cite{ATLAS2008}.}
...
\begin{table}[!htbp]
    ...
    \begin{tabular}{c|c|c|c|c}
        ...
        \hline\hline
    \end{tabular}
    \caption{Some important parameters of the EM calorimeter~\cite{ATLAS-TDR-04}.}
...
\begin{table}[!htbp]
    ...
    \begin{tabular}{c|c|c|c}
        ...
        \hline\hline
    \end{tabular}
    \caption{Some important parameters of the hadronic calorimeter~\cite{ATLAS-TDR-05}.}
...
\begin{figure}[!htbp]
    ...
    \caption{The ATLAS MS Barrel (a) and End-cap (b), layout for Run~1 and Run~2 operations~\cite{ATLAS-TDR-10,PERF-2007-01}.}
    \label{fig:MS-layout}
\end{figure}
...
\begin{table}[!htbp]
    ...
    \begin{tabular}{l|c}
        ...
        \hline\hline
    \end{tabular}
    \caption{Summary of important parameters of the Monitored Drift Tube chamber~\cite{ATLAS-TDR-10,PERF-2007-01}.}
...
\begin{table}[!htbp]
    ...
    \begin{tabular}{l|c}
        ...
        \hline\hline
    \end{tabular}
    \caption{Summary of important parameters of the Cathode Strip Chamber~\cite{ATLAS-TDR-10,PERF-2007-01}.}
...
\begin{table}[!htbp]
    ...
    \begin{tabular}{c|c}
        ...
        \hline\hline
    \end{tabular}
    \caption{Summary of important parameters of the Resistive Plate Chamber~\cite{ATLAS-TDR-10,PERF-2007-01}.}
...
\begin{table}[!htbp]
    ...
    \begin{tabular}{c|c}
        ...
        \hline\hline
    \end{tabular}
    \caption{Summary of important parameters of the Thin Gap Chamber~\cite{ATLAS-TDR-10,PERF-2007-01}.}

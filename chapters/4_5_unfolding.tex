...
% \begin{figure}[h!]
% \centering
%   \subfloat[\label{fig:unfolding_technical_closure_purity_eff_dphill_inclusive}]{\includegraphics[width=0.35\textwidth]{figures/Unfolding/technical_closure/inclusive/dphill/all_dphill.png}}
%   \subfloat[\label{fig:unfolding_technical_closure_migration_dphill_inclusive}]{\includegraphics[width=0.35\textwidth]{figures/Unfolding/technical_closure/inclusive/dphill/migration_dphill.png}}
%   \subfloat[\label{fig:unfolding_technical_closure_distribution_dphill_inclusive}]{\includegraphics[height=0.40\textwidth]{figures/Unfolding/technical_closure/inclusive/dphill/final_dphill.png}}
...
% \begin{figure}[h!]
% \centering
%   \subfloat[\label{fig:unfolding_technical_closure_purity_eff_n_jets_inclusive}]{\includegraphics[width=0.35\textwidth]{figures/Unfolding/technical_closure/inclusive/n_jets/all_n_jets.png}}
%   \subfloat[\label{fig:unfolding_technical_closure_migration_n_jets_inclusive}]{\includegraphics[width=0.35\textwidth]{figures/Unfolding/technical_closure/inclusive/n_jets/migration_n_jets.png}}
%   \subfloat[\label{fig:unfolding_technical_closure_distribution_n_jets_inclusive}]{\includegraphics[height=0.40\textwidth]{figures/Unfolding/technical_closure/inclusive/n_jets/final_n_jets.png}}
...
% \begin{figure}[h!]
% \centering
%   \subfloat[\label{fig:unfolding_technical_closure_purity_eff_mjj_ZZjj}]{\includegraphics[width=0.35\textwidth]{figures/Unfolding/technical_closure/ZZjj/mjj/all_mjj.png}}
%   \subfloat[\label{fig:unfolding_technical_closure_migration_mjj_ZZjj}]{\includegraphics[width=0.35\textwidth]{figures/Unfolding/technical_closure/ZZjj/mjj/migration_mjj.png}}
%   \subfloat[\label{fig:unfolding_technical_closure_distribution_mjj_ZZjj}]{\includegraphics[height=0.40\textwidth]{figures/Unfolding/technical_closure/ZZjj/mjj/final_mjj.png}}
...
% \begin{figure}[h!]
% \centering
%   \subfloat[\label{fig:unfolding_modelling_bias_dphill_inclusive}]{\includegraphics[width=0.49\textwidth]{figures/Unfolding/bias/inclusive/final_dphill.png}}
%   \subfloat[\label{fig:unfolding_modelling_bias_leading_pT_lepton_inclusive}]{\includegraphics[width=0.49\textwidth]{figures/Unfolding/bias/inclusive/final_leading_pT_lepton.png}} \\
%   \subfloat[\label{fig:unfolding_modelling_bias_mt_zz_inclusive}]{\includegraphics[width=0.49\textwidth]{figures/Unfolding/bias/inclusive/final_mt_zz.png}}
%   \subfloat[\label{fig:unfolding_modelling_bias_n_jets_inclusive}]{\includegraphics[width=0.49\textwidth]{figures/Unfolding/bias/inclusive/final_n_jets.png}}
...
% \begin{figure}[h!]
% \centering
%   \subfloat[\label{fig:unfolding_modelling_bias_dphill_ZZjj}]{\includegraphics[width=0.49\textwidth]{figures/Unfolding/bias/ZZjj/final_dphill.png}}
%   \subfloat[\label{fig:unfolding_modelling_bias_leading_jet_pt_ZZjj}]{\includegraphics[width=0.49\textwidth]{figures/Unfolding/bias/ZZjj/final_leading_jet_pt.png}} \\
%   \subfloat[\label{fig:unfolding_modelling_bias_mjj_ZZjj}]{\includegraphics[width=0.49\textwidth]{figures/Unfolding/bias/ZZjj/final_mjj.png}}
%   \subfloat[\label{fig:unfolding_modelling_bias_mt_zz_ZZjj}]{\includegraphics[width=0.49\textwidth]{figures/Unfolding/bias/ZZjj/final_mt_zz.png}}

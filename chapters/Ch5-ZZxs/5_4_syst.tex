...
and a set of background normalisation factors is obtained by fitting the distributions of $ \Delta\phi(\vec {E}_\text{T}^\text{miss}, Z)$ of the selected events from MC simulations to data in SRs and CRs. The postfit distributions of the $ \Delta\phi(\vec {E}_\text{T}^\text{miss}, Z)$ in the RSs and CRs are shown in Figure~\ref{fig:postfit_observed_ZZCR}.
%

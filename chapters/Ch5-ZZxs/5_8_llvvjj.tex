...
\begin{figure}[!htbp]
    \centering
    \subfloat[]{
        \includegraphics[width=0.3\linewidth]{figures/ch5-llvv/fig_postfit_d.pdf}
        \label{fig:postfit_leading_jet_pt}
    }
    \hfill
    \subfloat[]{
        \includegraphics[width=0.3\linewidth]{figures/ch5-llvv/fig_postfit_e.pdf}
        \label{fig:postfit_mjj}
    }
    \hfill
    \subfloat[]{
        \includegraphics[width=0.3\linewidth]{figures/ch5-llvv/fig_postfit_f.pdf}
...
\begin{figure}[p]
    \centering
    \subfloat[]{
        \includegraphics[width=0.45\linewidth]{figures/ch5-llvv/fig_diff_llvvjj_a.pdf}
        \label{fig:diff_llvvjj_z_pt}
    }
    \hfill
    \subfloat[]{
        \includegraphics[width=0.45\linewidth]{figures/ch5-llvv/fig_diff_llvvjj_b.pdf}
    ...
    \subfloat[]{
        \includegraphics[width=0.45\linewidth]{figures/ch5-llvv/fig_diff_llvvjj_c.pdf}
        \label{fig:diff_llvvjj_y_z}
    }
    \hfill
    \subfloat[]{
        \includegraphics[width=0.45\linewidth]{figures/ch5-llvv/fig_diff_llvvjj_d.pdf}
    ...
    \subfloat[]{
        \includegraphics[width=0.45\linewidth]{figures/ch5-llvv/fig_diff_llvvjj_e.pdf}
        \label{fig:diff_llvvjj_mt_zz}
    }
    \hfill
    \subfloat[]{
        \includegraphics[width=0.45\linewidth]{figures/ch5-llvv/fig_diff_llvvjj_f.pdf}
    ...
    \subfloat[]{
        \includegraphics[width=0.45\linewidth]{figures/ch5-llvv/fig_diff_llvvjj_g.pdf}
...
\begin{figure}[htbp]
    ...
    % Top Row: fT0 and fT1
    \subfloat[]{
        \includegraphics[width=0.45\linewidth]{figures/ch5-llvv/fig_aqgc_limit_fT0.pdf}
        \label{fig:aqgc_fT0}
    }
    \hfill
    \subfloat[]{
        \includegraphics[width=0.45\linewidth]{figures/ch5-llvv/fig_aqgc_limit_fT1.pdf}
        \label{fig:aqgc_fT1}
    }
    \\ % Line break for Bottom Row
    % Bottom Row: fT2 and fT3
    \subfloat[]{
        \includegraphics[width=0.45\linewidth]{figures/ch5-llvv/fig_aqgc_limit_fT2.pdf}
        \label{fig:aqgc_fT2}
    }
    \hfill
    \subfloat[]{
        \includegraphics[width=0.45\linewidth]{figures/ch5-llvv/fig_aqgc_limit_fT3.pdf}
        \label{fig:aqgc_fT3}
    }

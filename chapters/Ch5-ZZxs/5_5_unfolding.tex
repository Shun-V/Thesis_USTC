...
This analysis employs the \textbf{Iterative Bayesian Unfolding (IBU)} method \cite{dagostini2010improved}, implemented within the \texttt{RooUnfold} framework \cite{Adye:1349242}. 
...
\paragraph{Angular Variables: $\Delta\Phi(\ell,\ell)$ (Inclusive)}

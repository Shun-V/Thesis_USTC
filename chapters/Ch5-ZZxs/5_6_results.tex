...
\begin{figure}[!htbp]
    \centering
    \subfloat[]{
        \includegraphics[width=0.3\linewidth]{figures/llvv/fig_postfit_a.pdf}
        \label{fig:postfit_leading_lep_pt}
    }
    \hfill
    \subfloat[]{
        \includegraphics[width=0.3\linewidth]{figures/llvv/fig_postfit_b.pdf}
        \label{fig:postfit_met}
    }
    \hfill
    \subfloat[]{
        \includegraphics[width=0.3\linewidth]{figures/llvv/fig_postfit_c.pdf}
...
\begin{figure}[!hbtp]
    ...
    % Row 1
    \subfloat[]{
        \includegraphics[width=0.3\linewidth]{figures/llvv/fig_diff_llvv_a.pdf}
        \label{fig:diff_llvv_lep_pt}
    }
    \hfill
    \subfloat[]{
        \includegraphics[width=0.3\linewidth]{figures/llvv/fig_diff_llvv_b.pdf}
        \label{fig:diff_llvv_z_pt}
    }
    \hfill
    \subfloat[]{
        \includegraphics[width=0.3\linewidth]{figures/llvv/fig_diff_llvv_c.pdf}
        \label{fig:diff_llvv_dphi}
    }
    \\ % Line break for Row 2
    \subfloat[]{
        \includegraphics[width=0.3\linewidth]{figures/llvv/fig_diff_llvv_d.pdf}
        \label{fig:diff_llvv_y_z}
    }
    \hfill
    \subfloat[]{
        \includegraphics[width=0.3\linewidth]{figures/llvv/fig_diff_llvv_e.pdf}
        \label{fig:diff_llvv_pt_zz}
    }
    \hfill
    \subfloat[]{
        \includegraphics[width=0.3\linewidth]{figures/llvv/fig_diff_llvv_f.pdf}
        \label{fig:diff_llvv_mt_zz}
    }
    \\ % Line break for Row 3
    \subfloat[]{
        \includegraphics[width=0.3\linewidth]{figures/llvv/fig_diff_llvv_g.pdf}
        \label{fig:diff_llvv_njets}
    }
    \hfill
    \subfloat[]{
        \includegraphics[width=0.3\linewidth]{figures/llvv/fig_diff_llvv_h.pdf}
